...
impl DiagnosticFailureKind {
    const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::GenericExtractRequired => "generic_extract_required",
            ...
            Self::GenericSourceDocumentInvalid => "generic_source_document_invalid",
