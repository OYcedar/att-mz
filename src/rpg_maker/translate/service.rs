...
use crate::rpg_maker::lua::runtime::TrustedLuaTranslationSemantics;
...
pub(crate) trait SelectedTranslationExecutionBuilder: Send + Sync {
    ...
    type Standard: StandardTranslation<Profile = Arc<RpgMakerTranslationProfile<Self::Client>>>;
...
mod tests {
    ...
    type SelectedProfile = Arc<RpgMakerTranslationProfile<FakeClient>>;
    ...
    fn service(
        ...
        let profile = Arc::new(RpgMakerTranslationProfile::new(
            ...
            RpgMakerTranslationPlanningConfiguration::new(NonZeroUsize::MIN, NonZeroUsize::MIN),
    ...
    fn input(_: Option<&str>) -> TranslateInput {
        TranslateInput {
            name: project_name(),
            terminology_path: Some(PathBuf::from("config/terms.toml")),
            placeholder_rules_path: Some(PathBuf::from("config/placeholders.toml")),
        }
    }
